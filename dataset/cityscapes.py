...
class CityScapes(Dataset):
    ...
    def __init__(self, mode, root, height, width):
        ...
        self.to_tensor = transforms.Compose([
                            transforms.ToTensor(),
                            normalizer])
        #This transforms the label into a tensor, is uses a different component because 
        #for the label we need to scale [0,255] and not [0,1]
        ...
        for city in os.listdir(image_dir):
            ...
            #dataset is splitted by city, so we need to change directory
